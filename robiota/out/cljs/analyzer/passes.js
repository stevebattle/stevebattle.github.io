...
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__978_SHARP_){
return cljs.analyzer.passes.walk.call(null,p1__978_SHARP_,passes,opts);
})),child);
} else {
return cljs.analyzer.passes.walk.call(null,child,passes,opts);
}
})());
}),(function (){var G__981 = ast;
if((G__981 == null)){
return null;
} else {
return cljs.analyzer.passes.apply_passes.call(null,G__981,passes,opts);
}

...
var G__676 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__676;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__677 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__677,ch);
...
if(("\\" === ch__$1)){
var ch_678__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_678__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_678__$2);
} else {
}

var G__679 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__679;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__5043__auto__ = cljs.tools.reader.impl.utils.whitespace_QMARK_.call(null,ch);
if(or__5043__auto__){
return or__5043__auto__;
} else {
var or__5043__auto____$1 = cljs.tools.reader.macros.call(null,ch);
...
var vec__687 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__687,(0),null);
var start_column = cljs.core.nth.call(null,vec__687,(1),null);
...
var G__690 = cljs.core.conj_BANG_.call(null,a,form);
a = G__690;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__691 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__692 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__692);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__691);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__693 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__693,(0),null);
var start_column = cljs.core.nth.call(null,vec__693,(1),null);
...
var vec__696 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__696,(0),null);
var end_column = cljs.core.nth.call(null,vec__696,(1),null);
...
var vec__699 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__699,(0),null);
var start_column = cljs.core.nth.call(null,vec__699,(1),null);
...
var vec__702 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__702,(0),null);
var end_column = cljs.core.nth.call(null,vec__702,(1),null);
...
var vec__705 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__705,(0),null);
var start_column = cljs.core.nth.call(null,vec__705,(1),null);
...
var vec__708 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__708,(0),null);
var end_column = cljs.core.nth.call(null,vec__708,(1),null);
...
var sb = (function (){var G__711 = (new goog.string.StringBuffer());
G__711.append(initch);
...
var or__5043__auto__ = cljs.tools.reader.impl.commons.match_number.call(null,s);
...
var G__713 = (function (){var G__712 = sb;
G__712.append(ch);

return G__712;
})();
var G__714 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__713;
ch = G__714;
continue;
}
...
switch (G__717) {
case "\\":
var G__721 = (function (){var G__718 = sb;
G__718.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__718;
})();
var G__722 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__721;
ch = G__722;
continue;
...
break;
default:
var G__723 = (function (){var G__719 = sb;
G__719.append(ch);

return G__719;
})();
var G__724 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__723;
ch = G__724;
continue;
...
var vec__725 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__725,(0),null);
var end_column = cljs.core.nth.call(null,vec__725,(1),null);
...
var vec__728 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__728,(0),null);
var column = cljs.core.nth.call(null,vec__728,(1),null);
...
var or__5043__auto__ = cljs.tools.reader.resolve_alias.call(null,sym);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
var vec__733 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__733,(0),null);
var column = cljs.core.nth.call(null,vec__733,(1),null);
...
var vec__738 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__738,(0),null);
var column = cljs.core.nth.call(null,vec__738,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__743 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__743,(0),null);
var start_column = cljs.core.nth.call(null,vec__743,(1),null);
...
var vec__746 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__746,(0),null);
var end_column = cljs.core.nth.call(null,vec__746,(1),null);
...
var G__749 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__749,true,null,opts,pending_forms);
...
var G__750 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__750)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__750)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__750)){
...
if((form === cljs.tools.reader.READ_EOF)){
return cljs.tools.reader.impl.errors.throw_eof_error.call(null,rdr,(function (){var and__5041__auto__ = (first_line < (0));
...
var _STAR_suppress_read_STAR__orig_val__751 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__752 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__752);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__751);
}});
...
var G__753 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__753,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__753,rdr,first_line);

return G__753;
} else {
var or__5043__auto__ = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
var G__757 = matched;
var G__758 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__757;
finished = G__758;
continue;
} else {
...
if(cljs.core.not.call(null,(function (){var and__5041__auto__ = opts;
if(cljs.core.truth_(and__5041__auto__)){
...
var _STAR_suppress_read_STAR__orig_val__759 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__760 = (function (){var or__5043__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__760);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__759);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__761 = cljs.tools.reader.arg_env;
var arg_env_temp_val__762 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__762);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__763 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__763,"(");
...
var G__764 = (i + (1));
var G__765 = cljs.core.conj_BANG_.call(null,args,(function (){var or__5043__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__761);
}});
/**
...
var ch = temp__5802__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__766 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__766);
...
var G__767 = cljs.core.next.call(null,s__$1);
var G__768 = ret;
s__$1 = G__767;
r = G__768;
continue;
...
var G__769 = cljs.core.next.call(null,s);
var G__770 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__769;
key_vals = G__770;
continue;
} else {
...
var or__5043__auto__ = cljs.core.get.call(null,cljs.tools.reader.gensym_env,sym);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
var gensym_env_orig_val__773 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__774 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__774);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__773);
}});
cljs.tools.reader.read_namespaced_map = (function cljs$tools$reader$read_namespaced_map(rdr,_,opts,pending_forms){
var vec__775 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__775,(0),null);
var start_column = cljs.core.nth.call(null,vec__775,(1),null);
...
var temp__5802__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__778 = token;
var G__778__$1 = (((G__778 == null))?null:cljs.core.subs.call(null,G__778,(1)));
var G__778__$2 = (((G__778__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__778__$1));
var G__778__$3 = (((G__778__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__778__$2));
var G__778__$4 = (((G__778__$3 == null))?null:cljs.core.symbol.call(null,G__778__$3));
if((G__778__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__778__$4);
}
})():(function (){var G__779 = token;
var G__779__$1 = (((G__779 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__779));
if((G__779__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__779__$1);
}
})()
));
if(cljs.core.truth_(temp__5802__auto__)){
...
var vec__780 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__780,(0),null);
var end_column = cljs.core.nth.call(null,vec__780,(1),null);
...
}catch (e789){if((e789 instanceof Error)){
var e = e789;
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__793,reader){
var map__794 = p__793;
var map__794__$1 = cljs.core.__destructure_map.call(null,map__794);
var opts = map__794__$1;
var eof = cljs.core.get.call(null,map__794__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));

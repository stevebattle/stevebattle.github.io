...
var digit_2187 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_2188__$1 = (vlq >>> (5));
while(true){
if((vlq_2188__$1 > (0))){
var digit_2189__$1 = (digit_2187 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_2189__$1));

var G__2190 = (vlq_2188__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__2191 = (vlq_2188__$1 >>> (5));
digit_2187 = G__2190;
vlq_2188__$1 = G__2191;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_2187));
}
break;
}
...
var G__2192 = i__$1;
var G__2193 = result__$1;
var G__2194 = shift__$1;
i = G__2192;
result = G__2193;
shift = G__2194;
continue;
